...
class BaxterEnv(MujocoEnv):
    ...
    def convert_tool_to_joints(self, param):
        ...
        [right_desired_x, right_desired_y, right_desired_z, right_desired_teta_x, right_desired_teta_y, right_desired_teta_z, right_K_pos, right_C_pos, right_K_ori,
         right_C_ori] = param[:10]

        [left_desired_x, left_desired_y, left_desired_z, left_desired_teta_x, left_desired_teta_y,left_desired_teta_z, left_K_pos, left_C_pos, left_K_ori,
         left_C_ori] = param[10:]
